...
public class Camera {
    ...
    private void triggerImageCapture() {
        try {
            ...
            Log.d(TAG, "Trigger session initialized.");
    ...
    private final CameraCaptureSession.CaptureCallback mCaptureCallback =
            new CameraCaptureSession.CaptureCallback() {
                ...
                public void onCaptureProgressed(CameraCaptureSession session,
                    ...
                    Log.d(TAG, "CaptureProgressed called");
                }
                ...
                public void onCaptureCompleted(CameraCaptureSession session,
                    ...
                    Log.d(TAG, "CaptureCompleted called");
                    if (session != null) {
                        session.close();
                ...
                public void onCaptureStarted(CameraCaptureSession session, CaptureRequest request, long timestamp, long frameNumber) {
                    Log.d(TAG, "onCaptureStarted called");
                }

                public void onCaptureFailed(CameraCaptureSession session, CaptureRequest request, CaptureFailure failure) {
                    Log.d(TAG, "onCaptureFailed called");
                }

                public void onCaptureSequenceCompleted(CameraCaptureSession session, int sequenceId, long frameNumber) {
                    Log.d(TAG, "onCaptureSequenceCompleted called");
                }

                public void onCaptureSequenceAborted(CameraCaptureSession session, int sequenceId) {
                    Log.d(TAG, "onCaptureSequenceAborted called");
                }

                public void onCaptureBufferLost(CameraCaptureSession session, CaptureRequest request, Surface target, long frameNumber) {
                    Log.d(TAG, "onCaptureBufferLost called");
                }
